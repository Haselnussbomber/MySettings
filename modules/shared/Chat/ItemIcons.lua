...
local handlers = {
	["(|?%x*|Hitem:(.-)|h.-|h|?r?)"] = function(link, linkData)
	...
	["(|?%x*|Hspell:(.-)|h.-|h|?r?)"] = function(link, linkData)
...
if (WOW_PROJECT_ID == WOW_PROJECT_MAINLINE) then
	handlers["(|?%x*|Hachievement:(.-)|h.-|h|?r?)"] = function(link, linkData)
	...
	handlers["(|?%x*|Hbattlepet:(.-)|h.-|h|?r?)"] = function(link)
